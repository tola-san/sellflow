    ...
    <div className="dashboard-theme min-h-screen bg-slate-50 text-slate-900" data-dashboard-theme={dashboardTheme} style={dashboardThemeVariables(DASHBOARD_THEMES[dashboardTheme])}>
      ...
      {open && (
        <>
          ...
          />
          <aside className="fixed inset-y-0 left-0 z-40 flex w-[min(18rem,calc(100vw-2rem))] flex-col bg-white lg:hidden">
            {sidebar(false, true)}
          </aside>
        </>
      )}
            ...
            <div className="relative">
              {user ? (
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2 py-1.5 text-sm transition hover:bg-slate-50 sm:px-3"
                >
              ...
              {profileOpen && user && (
                <>
                  ...
                  />
                  <div className="absolute right-0 z-50 mt-2 w-[min(14rem,calc(100vw-1.5rem))] rounded-xl border border-slate-200 bg-white py-1 shadow-lg">
                    ...
                    <button onClick={() => { setProfileOpen(false); navigate("/dashboard/settings"); }} className="flex w-full items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition">
                      <User size={16} />
                      My Profile
                    </button>
                    <button onClick={() => { setProfileOpen(false); navigate("/dashboard/settings"); }} className="flex w-full items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition">
