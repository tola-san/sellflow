    ...
    <section className="relative pt-20 pb-16 lg:pt-32 lg:pb-24 overflow-hidden bg-zinc-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 lg:mb-16">
          <div className="max-w-4xl mx-auto text-center mb-12 lg:mb-16">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-50 backdrop-blur-xl border border-white text-purple-400 text-sm font-medium mb-8 shadow-sm">
