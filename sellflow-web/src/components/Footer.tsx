        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="flex flex-col gap-8 border-b border-[#dfd7e8] pb-10 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-[.18em] text-[#8754d8]">Ready when you are</p>
              <h2 className="mt-4 text-3xl font-medium tracking-[-.045em] sm:text-5xl">A better way to sell starts here.</h2>
              <p className="mt-4 max-w-xl text-sm leading-7 text-[#746d7d]">Create your storefront, share one link, and keep your business moving from one simple workspace.</p>
            </div>
            <Link to="/register" className="group inline-flex h-12 shrink-0 items-center justify-center gap-2 self-start rounded-xl bg-[#8754d8] px-5 text-sm font-semibold text-white shadow-lg shadow-violet-200 transition hover:-translate-y-1 hover:bg-[#7543bd] lg:self-auto">Start for free <ArrowUpRight className="h-4 w-4 transition group-hover:translate-x-0.5 group-hover:-translate-y-0.5" /></Link>
          </div>
