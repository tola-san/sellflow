...
export const THEME_PRESETS: Record<ThemePreset, ThemeSettings> = {
  ...
  classic: {
    ...
    button_style: "rounded", hero_style: "banner", grid_columns: 3,
  },
};
